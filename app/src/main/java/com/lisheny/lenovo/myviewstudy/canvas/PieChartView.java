...
public class PieChartView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(((pieChartCircleRectF.left + pieChartCircleRadius * 2)-
                ( getWidth() / 2 - pieChartCircleRadius))/2+
                (getWidth() / 2 - pieChartCircleRadius),
                ((pieChartCircleRectF.top + pieChartCircleRadius * 2)-
                        (getHeight() / 2 - pieChartCircleRadius))/2+
                        (getHeight() / 2 - pieChartCircleRadius),
                width/9,paint);
